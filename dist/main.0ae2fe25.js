...
},{}],"+oI1":[function(require,module,exports) {
...
},{"process":"+oI1"}],"U+s5":[function(require,module,exports) {
"use strict";
...
var buttonCal = function buttonCal(btn, fn) {
...
buttonCal($button1, function (n) {
  return n + 1;
});
buttonCal($button2, function (n) {
  return n - 1;
});
buttonCal($button3, function (n) {
  return n * 2;
});
buttonCal($button4, function (n) {
  return n / 2;
});
...
//# sourceMappingURL=main.0ae2fe25.js.map